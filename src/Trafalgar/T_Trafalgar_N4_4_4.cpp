...
void main () {
   ...
   Tests::Begin("_Trafalgar.Navire", "1.3.0");
	...
	Trafalgar::modifierMeteo("OAB",TEMPETE);
	Trafalgar::appliquer("Cassard",TEMPETE);
	Trafalgar::appliquer("Tonnerre",TEMPETE);
	
	Tests::Case("Service debarquer - Navire occupé –> Ile vierge - Meteo TEMPETE"); {
		...
		Tests::Unit(600, Trafalgar::obtenirIle("OAB")->effectifs("bleue"));
	}
	
	Tests::Case("Service debarquer - Navire occupé –> Ile occupée - Meteo TEMPETE"); {
		...
		Tests::Unit(144, Trafalgar::obtenirIle("OAB")->effectifs("rouge"));
		Tests::Unit(0, Trafalgar::obtenirIle("OAB")->effectifs("bleue"));
	}
	
	Tests::Case("Service debarquer - Navire occupé –> Ile prise - Meteo TEMPETE"); {
		...
		Tests::Unit(504, Trafalgar::obtenirIle("OAB")->effectifs("rouge"));
		Tests::Unit(0, Trafalgar::obtenirIle("OAB")->effectifs("bleue"));
	}
	
	Tests::Case("Service debarquer - Navire vide –> Ile prise - Meteo TEMPETE"); {
	...
	Tests::Case("Service embarquer - Ile prise –> Navire vide - Meteo TEMPETE"); {
		
		Tests::Unit(504, Trafalgar::obtenirIle("OAB")->effectifs("rouge"));
		Tests::Unit(0, Trafalgar::obtenirNavire("Tonnerre")->nbSoldats());
		
		Trafalgar::embarquer("Tonnerre","OAB", 504);
		
		Tests::Unit(0, Trafalgar::obtenirIle("OAB")->effectifs("rouge"));
		Tests::Unit(302, Trafalgar::obtenirNavire("Tonnerre")->nbSoldats());
	}
	
	Tests::Case("Service embarquer - Ile vide –> Navire occupé - Meteo TEMPETE"); {
