...
void main () {
   ...
   Tests::Begin("_Trafalgar.Navire", "1.3.0");
	...
	Tests::Case("Service debarquer - Navire occupé –> Ile vierge - Meteo AGITEE"); {
		...
		Tests::Unit(850, Trafalgar::obtenirIle("OAB")->effectifs("bleue"));
	}
	
	Tests::Case("Service debarquer - Navire occupé –> Ile occupée - Meteo AGITEE"); {
		...
		Tests::Unit(204, Trafalgar::obtenirIle("OAB")->effectifs("rouge"));
		Tests::Unit(0, Trafalgar::obtenirIle("OAB")->effectifs("bleue"));
	}
	
	Tests::Case("Service debarquer - Navire occupé –> Ile prise - Meteo AGITEE"); {
		...
		Tests::Unit(714, Trafalgar::obtenirIle("OAB")->effectifs("rouge"));
		Tests::Unit(0, Trafalgar::obtenirIle("OAB")->effectifs("bleue"));
	}
	
	Tests::Case("Service debarquer - Navire vide –> Ile prise - Meteo AGITEE"); {
	...
	Tests::Case("Service embarquer - Ile prise –> Navire vide - Meteo AGITEE"); {
		
		Tests::Unit(714, Trafalgar::obtenirIle("OAB")->effectifs("rouge"));
		Tests::Unit(0, Trafalgar::obtenirNavire("Tonnerre")->nbSoldats());
		
		Trafalgar::embarquer("Tonnerre","OAB", 714);
		
		Tests::Unit(0, Trafalgar::obtenirIle("OAB")->effectifs("rouge"));
		Tests::Unit(606, Trafalgar::obtenirNavire("Tonnerre")->nbSoldats());
	}
	
	Tests::Case("Service embarquer - Ile vide –> Navire occupé - Meteo AGITEE"); {
